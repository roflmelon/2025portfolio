const BackendSVG = () => {
  ...
  <path 
    className="transition-all duration-500 group-hover:fill-[#599636] fill-white"
  ...
  <path 
    className="transition-all duration-500 group-hover:fill-[#6cac48] fill-white"
  ...
  <path 
    className="transition-all duration-500 group-hover:fill-[#c2bfbf] fill-white"
